...
public class BotCompetition {
    ...
    public static void main(String[] args) {
        new BotCompetition(BarBot.class, BazBot.class).compete(1);
    }

    // 序号，获胜的bot，坐庄的bot，耗时1，调用次数1，耗时2，调用次数2，本局总耗时
    public void compete(int gameCount) {
        try {
            //LogManager.getLogManager().readConfiguration(CliRunner.class.getResource("/logging_botcompetition.properties").openStream());
